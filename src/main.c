...
int main()
{
  ...
  SceCtrlData pad;
  callbacks_setup();
  g2dTexture* background = g2dTexLoad("background.png",G2D_SWIZZLE);
  g2dTexture* grunio = g2dTexLoad("grunio.png",G2D_SWIZZLE); 	
  g2dTexture* testmove = g2dTexLoad("testmove.png",G2D_SWIZZLE);
  g2dTexture* blue_carrot = g2dTexLoad("marchewblue.png",G2D_SWIZZLE);
  g2dTexture* red_carrot = g2dTexLoad("marchewred.png",G2D_SWIZZLE);
